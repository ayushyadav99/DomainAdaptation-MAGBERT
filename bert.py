...
import global_configs as config
...
class MAG_BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config, multimodal_config):
        ...
        # self.dataset = config.dataset // CH*
    ...
    Returns:
        ...
        """ Commened out classifier code. Instead returned pooling layer outputs """
...
class BertClassifier(nn.Module):
    def __init__(self, dropout=0.1):
        ...
        """ Classifier layer from above function """
        # self.classifier = nn.Linear(config.hidden_size, config.num_labels)
        self.classifier = nn.Linear(config.hidden_size, config.num_labels)
