...
def set_up_data_loader():
    ...
    tgt_train_dataset = get_appropriate_dataset(tgt_train_data)
    tgt_dev_dataset = get_appropriate_dataset(tgt_dev_data)
    tgt_test_dataset = get_appropriate_dataset(tgt_test_data)
...
def main():
    ...
    adapt(args, model, tgt_model, discriminator,
       src_classifier, src_data_loader, tgt_data_train_loader, tgt_data_all_loader):
